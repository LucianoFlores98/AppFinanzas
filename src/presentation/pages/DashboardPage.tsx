...
import { mockFinancialStats, mockBudgets, mockTransactions, mockExpensesOverTime } from '../../infrastructure/data/mockData';
  ...
  return (
    <div className="flex-1 bg-gray-50 overflow-auto">
      <div className="p-8">
        ...
        <p className="text-emerald-600 mb-8">Here's a quick overview of your financial health.</p>
